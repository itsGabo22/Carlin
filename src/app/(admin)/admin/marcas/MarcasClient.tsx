      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold font-serif text-gray-900 flex items-center gap-2">
            <Tags className="text-brand-pink shrink-0" /> Marcas
          </h1>
          <p className="text-xs sm:text-sm text-gray-500">Administra las marcas de los productos.</p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="block sm:hidden divide-y divide-gray-100">
          {filteredBrands.map((brand) => (
            <div key={brand.id} className="p-3 flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-gray-100 border border-gray-200 overflow-hidden flex items-center justify-center text-gray-400 shrink-0">
                {brand.logoUrl ? (
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-blue-50 text-blue-700 mt-1">
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-9 w-9 text-red-600 hover:text-red-700 hover:bg-red-50 disabled:opacity-30"
